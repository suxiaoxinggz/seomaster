...
const NavItem: React.FC<{
    ...
    <button
        ...
        className={`group relative flex items-center w-full px-4 py-3 my-1 transition-all duration-300 rounded-lg overflow-hidden ${
            isActive
    ...
    >
        ...
        <div className={`ml-3 whitespace-nowrap transition-all duration-300 origin-left ${
