...
const ModelSettings: React.FC = () => {
  ...
  const { models, setModels, defaultModelId, setDefaultModelId, session, supabase, fetchData, seoConfig, setSeoConfig } = context;
        ...
        <div className="space-y-5">
          ...
          {testStatus !== 'idle' && (
              <div className={`p-3 rounded-lg border text-sm ${
                  testStatus === 'success' ? 'bg-green-900/20 border-green-800 text-green-300' : 
